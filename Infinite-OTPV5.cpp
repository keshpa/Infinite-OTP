...
void replaceFoldCyclesCM(vector<uint16_t>& input, uint32_t start, uint32_t end) {
	if (end == 0) end = input.size();
	{
		// Process 1st section of 128 bits
		register uint16_t* bptr1 = input.data()+start;
		...
		register uint16_t va3 = va2 ^ substitutionTable[*SA(2) ^ epuk_otp[2]];
		register uint16_t va4 = va3 ^ substitutionTable[*SA(3) ^ epuk_otp[3]];
		register uint16_t va5 = va4 ^ substitutionTable[*SA(4) ^ epuk_otp[4]];
		register uint16_t va6 = va5 ^ substitutionTable[*SA(5) ^ epuk_otp[5]];
		register uint16_t va7 = va6 ^ substitutionTable[*SA(6) ^ epuk_otp[6]];
		register uint16_t va8 = va7 ^ substitutionTable[*SA(7) ^ epuk_otp[7]];

		// Process 2nd section of 128 bits
		register uint16_t vb1 = va8 ^ substitutionTable[*SB(0) ^ epuk_otp[8]];
		register uint16_t vb2 = vb1 ^ substitutionTable[*SB(1) ^ epuk_otp[9]];
		register uint16_t vb3 = vb2 ^ substitutionTable[*SB(2) ^ epuk_otp[10]];
		register uint16_t vb4 = vb3 ^ substitutionTable[*SB(3) ^ epuk_otp[11]];
		register uint16_t vb5 = vb4 ^ substitutionTable[*SB(4) ^ epuk_otp[12]];
		register uint16_t vb6 = vb5 ^ substitutionTable[*SB(5) ^ epuk_otp[13]];
		register uint16_t vb7 = vb6 ^ substitutionTable[*SB(6) ^ epuk_otp[14]];
		register uint16_t vb8 = vb7 ^ substitutionTable[*SB(7) ^ epuk_otp[15]];

		// Process 3rd section of 128 bits
		register uint16_t vc1 = vb8 ^ substitutionTable[*SC(0) ^ epuk_otp[16]];
		register uint16_t vc2 = vc1 ^ substitutionTable[*SC(1) ^ epuk_otp[17]];
		register uint16_t vc3 = vc2 ^ substitutionTable[*SC(2) ^ epuk_otp[18]];
		...
		// Process 4th section of 128 bits
		register uint16_t vd1 = vc8 ^ substitutionTable[*SD(0) ^ epuk_otp[24]];
		register uint16_t vd2 = vd1 ^ substitutionTable[*SD(1) ^ epuk_otp[25]];
		register uint16_t vd3 = vd2 ^ substitutionTable[*SD(2) ^ epuk_otp[26]];
		register uint16_t vd4 = vd3 ^ substitutionTable[*SD(3) ^ epuk_otp[27]];
		register uint16_t vd5 = vd4 ^ substitutionTable[*SD(4) ^ epuk_otp[28]];
		register uint16_t vd6 = vd5 ^ substitutionTable[*SD(5) ^ epuk_otp[29]];
		register uint16_t vd7 = vd6 ^ substitutionTable[*SD(6) ^ epuk_otp[30]];
		register uint16_t vd8 = vd7 ^ substitutionTable[*SD(7) ^ epuk_otp[31]];


		// Process 5th section of 128 bits
		register uint16_t ve1 = vd8 ^ substitutionTable[*SE(0) ^ epuk_otp[32]];
		register uint16_t ve2 = ve1 ^ substitutionTable[*SE(1) ^ epuk_otp[33]];
		register uint16_t ve3 = ve2 ^ substitutionTable[*SE(2) ^ epuk_otp[34]];
		register uint16_t ve4 = ve3 ^ substitutionTable[*SE(3) ^ epuk_otp[35]];
		register uint16_t ve5 = ve4 ^ substitutionTable[*SE(4) ^ epuk_otp[36]];
		register uint16_t ve6 = ve5 ^ substitutionTable[*SE(5) ^ epuk_otp[37]];
		register uint16_t ve7 = ve6 ^ substitutionTable[*SE(6) ^ epuk_otp[38]];
		register uint16_t ve8 = ve7 ^ substitutionTable[*SE(7) ^ epuk_otp[39]];


		// Process 6th section of 128 bits
		register uint16_t vf1 = ve8 ^ substitutionTable[*SF(0) ^ epuk_otp[40]];
		register uint16_t vf2 = vf1 ^ substitutionTable[*SF(1) ^ epuk_otp[41]];
		register uint16_t vf3 = vf2 ^ substitutionTable[*SF(2) ^ epuk_otp[42]];
		register uint16_t vf4 = vf3 ^ substitutionTable[*SF(3) ^ epuk_otp[43]];
		register uint16_t vf5 = vf4 ^ substitutionTable[*SF(4) ^ epuk_otp[44]];
		register uint16_t vf6 = vf5 ^ substitutionTable[*SF(5) ^ epuk_otp[45]];
		register uint16_t vf7 = vf6 ^ substitutionTable[*SF(6) ^ epuk_otp[46]];
		register uint16_t vf8 = vf7 ^ substitutionTable[*SF(7) ^ epuk_otp[47]];


		// Process 7th section of 128 bits
		register uint16_t vg1 = vf8 ^ substitutionTable[*SG(0) ^ epuk_otp[48]];
		register uint16_t vg2 = vg1 ^ substitutionTable[*SG(1) ^ epuk_otp[49]];
		register uint16_t vg3 = vg2 ^ substitutionTable[*SG(2) ^ epuk_otp[50]];
		register uint16_t vg4 = vg3 ^ substitutionTable[*SG(3) ^ epuk_otp[51]];
		register uint16_t vg5 = vg4 ^ substitutionTable[*SG(4) ^ epuk_otp[52]];
		register uint16_t vg6 = vg5 ^ substitutionTable[*SG(5) ^ epuk_otp[53]];
		register uint16_t vg7 = vg6 ^ substitutionTable[*SG(6) ^ epuk_otp[54]];
		register uint16_t vg8 = vg7 ^ substitutionTable[*SG(7) ^ epuk_otp[55]];


		// Process 8th section of 128 bits
		register uint16_t vh1 = vg8 ^ substitutionTable[*SH(0) ^ epuk_otp[56]];
		register uint16_t vh2 = vh1 ^ substitutionTable[*SH(1) ^ epuk_otp[57]];
		register uint16_t vh3 = vh2 ^ substitutionTable[*SH(2) ^ epuk_otp[58]];
		register uint16_t vh4 = vh3 ^ substitutionTable[*SH(3) ^ epuk_otp[59]];
		register uint16_t vh5 = vh4 ^ substitutionTable[*SH(4) ^ epuk_otp[60]];
		register uint16_t vh6 = vh5 ^ substitutionTable[*SH(5) ^ epuk_otp[61]];
		register uint16_t vh7 = vh6 ^ substitutionTable[*SH(6) ^ epuk_otp[62]];
		register uint16_t vh8 = vh7 ^ substitutionTable[*SH(7) ^ epuk_otp[63]];
...
void reverseReplaceFoldCyclesCM(vector<uint16_t>& input, uint32_t start, uint32_t end) {
	if (end == 0) end = input.size();
	{
		...
		register uint16_t vh4 = *SH(3) ^ epuk_otp4[59]; 
		register uint16_t vh3 = *SH(2) ^ epuk_otp4[58]; 
		register uint16_t vh2 = *SH(1) ^ epuk_otp4[57]; 
		register uint16_t vh1 = *SH(0) ^ epuk_otp4[56]; 

		vh8 = substitutionTable[vh8 ^ vh7] ^ epuk_otp[63];
		vh7 = substitutionTable[vh7 ^ vh6] ^ epuk_otp[62];
		vh6 = substitutionTable[vh6 ^ vh5] ^ epuk_otp[61];
		vh5 = substitutionTable[vh5 ^ vh4] ^ epuk_otp[60];
		vh4 = substitutionTable[vh4 ^ vh3] ^ epuk_otp[59];
		vh3 = substitutionTable[vh3 ^ vh2] ^ epuk_otp[58];
		vh2 = substitutionTable[vh2 ^ vh1] ^ epuk_otp[57];
		register uint16_t vg8 = *SG(7) ^ epuk_otp4[55]; 
		vh1 = substitutionTable[vh1 ^ vg8] ^ epuk_otp[56];

		// Process 7th section of 128 bits
		register uint16_t vg7 = *SG(6) ^ epuk_otp4[54]; 
		register uint16_t vg6 = *SG(5) ^ epuk_otp4[53]; 
		register uint16_t vg5 = *SG(4) ^ epuk_otp4[52]; 
		register uint16_t vg4 = *SG(3) ^ epuk_otp4[51]; 
		register uint16_t vg3 = *SG(2) ^ epuk_otp4[50]; 
		register uint16_t vg2 = *SG(1) ^ epuk_otp4[49]; 
		register uint16_t vg1 = *SG(0) ^ epuk_otp4[48]; 

		vg8 = substitutionTable[vg8 ^ vg7] ^ epuk_otp[55];
		vg7 = substitutionTable[vg7 ^ vg6] ^ epuk_otp[54];
		vg6 = substitutionTable[vg6 ^ vg5] ^ epuk_otp[53];
		vg5 = substitutionTable[vg5 ^ vg4] ^ epuk_otp[52];
		vg4 = substitutionTable[vg4 ^ vg3] ^ epuk_otp[51];
		vg3 = substitutionTable[vg3 ^ vg2] ^ epuk_otp[50];
		vg2 = substitutionTable[vg2 ^ vg1] ^ epuk_otp[49];
		register uint16_t vf8 = *SF(7) ^ epuk_otp4[47]; 
		vg1 = substitutionTable[vg1 ^ vf8] ^ epuk_otp[48];


		// Process 6th section of 128 bits
		register uint16_t vf7 = *SF(6) ^ epuk_otp4[46]; 
		register uint16_t vf6 = *SF(5) ^ epuk_otp4[45]; 
		register uint16_t vf5 = *SF(4) ^ epuk_otp4[44]; 
		register uint16_t vf4 = *SF(3) ^ epuk_otp4[43]; 
		register uint16_t vf3 = *SF(2) ^ epuk_otp4[42]; 
		register uint16_t vf2 = *SF(1) ^ epuk_otp4[41]; 
		register uint16_t vf1 = *SF(0) ^ epuk_otp4[40]; 

		vf8 = substitutionTable[vf8 ^ vf7] ^ epuk_otp[47];
		vf7 = substitutionTable[vf7 ^ vf6] ^ epuk_otp[46];
		vf6 = substitutionTable[vf6 ^ vf5] ^ epuk_otp[45];
		vf5 = substitutionTable[vf5 ^ vf4] ^ epuk_otp[44];
		vf4 = substitutionTable[vf4 ^ vf3] ^ epuk_otp[43];
		vf3 = substitutionTable[vf3 ^ vf2] ^ epuk_otp[42];
		vf2 = substitutionTable[vf2 ^ vf1] ^ epuk_otp[41];
		register uint16_t ve8 = *SE(7) ^ epuk_otp4[39]; 
		vf1 = substitutionTable[vf1 ^ ve8] ^ epuk_otp[40];

		// Process 5th section of 128 bits
		register uint16_t ve7 = *SE(6) ^ epuk_otp4[38]; 
		register uint16_t ve6 = *SE(5) ^ epuk_otp4[37]; 
		register uint16_t ve5 = *SE(4) ^ epuk_otp4[36]; 
		register uint16_t ve4 = *SE(3) ^ epuk_otp4[35]; 
		register uint16_t ve3 = *SE(2) ^ epuk_otp4[34]; 
		register uint16_t ve2 = *SE(1) ^ epuk_otp4[33]; 
		register uint16_t ve1 = *SE(0) ^ epuk_otp4[32]; 

		ve8 = substitutionTable[ve8 ^ ve7] ^ epuk_otp[39];
		ve7 = substitutionTable[ve7 ^ ve6] ^ epuk_otp[38];
		ve6 = substitutionTable[ve6 ^ ve5] ^ epuk_otp[37];
		ve5 = substitutionTable[ve5 ^ ve4] ^ epuk_otp[36];
		ve4 = substitutionTable[ve4 ^ ve3] ^ epuk_otp[35];
		ve3 = substitutionTable[ve3 ^ ve2] ^ epuk_otp[34];
		ve2 = substitutionTable[ve2 ^ ve1] ^ epuk_otp[33];
		register uint16_t vd8 = *SD(7) ^ epuk_otp4[31]; 
		ve1 = substitutionTable[ve1 ^ vd8] ^ epuk_otp[32];

		// Process 4th section of 128 bits
		register uint16_t vd7 = *SD(6) ^ epuk_otp4[30]; 
		register uint16_t vd6 = *SD(5) ^ epuk_otp4[29]; 
		register uint16_t vd5 = *SD(4) ^ epuk_otp4[28]; 
		register uint16_t vd4 = *SD(3) ^ epuk_otp4[27]; 
		register uint16_t vd3 = *SD(2) ^ epuk_otp4[26]; 
		register uint16_t vd2 = *SD(1) ^ epuk_otp4[25]; 
		register uint16_t vd1 = *SD(0) ^ epuk_otp4[24]; 

		vd8 = substitutionTable[vd8 ^ vd7] ^ epuk_otp[31];
		vd7 = substitutionTable[vd7 ^ vd6] ^ epuk_otp[30];
		vd6 = substitutionTable[vd6 ^ vd5] ^ epuk_otp[29];
		vd5 = substitutionTable[vd5 ^ vd4] ^ epuk_otp[28];
		vd4 = substitutionTable[vd4 ^ vd3] ^ epuk_otp[27];
		vd3 = substitutionTable[vd3 ^ vd2] ^ epuk_otp[26];
		vd2 = substitutionTable[vd2 ^ vd1] ^ epuk_otp[25];
		register uint16_t vc8 = *SC(7) ^ epuk_otp4[23];
		vd1 = substitutionTable[vd1 ^ vc8] ^ epuk_otp[24];

		// Process 3rd section of 128 bits
		register uint16_t vc7 = *SC(6) ^ epuk_otp4[22]; 
		register uint16_t vc6 = *SC(5) ^ epuk_otp4[21]; 
		register uint16_t vc5 = *SC(4) ^ epuk_otp4[20]; 
		register uint16_t vc4 = *SC(3) ^ epuk_otp4[19]; 
		register uint16_t vc3 = *SC(2) ^ epuk_otp4[18]; 
		register uint16_t vc2 = *SC(1) ^ epuk_otp4[17]; 
		...
		vc3 = substitutionTable[vc3 ^ vc2] ^ epuk_otp[18];
		vc2 = substitutionTable[vc2 ^ vc1] ^ epuk_otp[17];
		register uint16_t vb8 = *SB(7) ^ epuk_otp4[15];
		vc1 = substitutionTable[vc1 ^ vb8] ^ epuk_otp[16];

		// Process 2nd section of 128 bits
		register uint16_t vb7 = *SB(6) ^ epuk_otp4[14]; 
		register uint16_t vb6 = *SB(5) ^ epuk_otp4[13]; 
		register uint16_t vb5 = *SB(4) ^ epuk_otp4[12]; 
		register uint16_t vb4 = *SB(3) ^ epuk_otp4[11]; 
		register uint16_t vb3 = *SB(2) ^ epuk_otp4[10]; 
		register uint16_t vb2 = *SB(1) ^ epuk_otp4[9]; 
		register uint16_t vb1 = *SB(0) ^ epuk_otp4[8]; 

		vb8 = substitutionTable[vb8 ^ vb7] ^ epuk_otp[15];
		vb7 = substitutionTable[vb7 ^ vb6] ^ epuk_otp[14];
		vb6 = substitutionTable[vb6 ^ vb5] ^ epuk_otp[13];
		vb5 = substitutionTable[vb5 ^ vb4] ^ epuk_otp[12];
		vb4 = substitutionTable[vb4 ^ vb3] ^ epuk_otp[11];
		vb3 = substitutionTable[vb3 ^ vb2] ^ epuk_otp[10];
		vb2 = substitutionTable[vb2 ^ vb1] ^ epuk_otp[9];
		register uint16_t va8 = *SA(7) ^ epuk_otp4[7];
		vb1 = substitutionTable[vb1 ^ va8] ^ epuk_otp[8];

		// Process 1st section of 128 bits
		register uint16_t va7 = *SA(6) ^ epuk_otp4[6]; 
		register uint16_t va6 = *SA(5) ^ epuk_otp4[5]; 
		register uint16_t va5 = *SA(4) ^ epuk_otp4[4]; 
		register uint16_t va4 = *SA(3) ^ epuk_otp4[3]; 
		register uint16_t va3 = *SA(2) ^ epuk_otp4[2]; 
		register uint16_t va2 = *SA(1) ^ epuk_otp4[1]; 

		va8 = substitutionTable[va8 ^ va7] ^ epuk_otp[7];
		va7 = substitutionTable[va7 ^ va6] ^ epuk_otp[6];
		va6 = substitutionTable[va6 ^ va5] ^ epuk_otp[5];
		va5 = substitutionTable[va5 ^ va4] ^ epuk_otp[4];
		va4 = substitutionTable[va4 ^ va3] ^ epuk_otp[3];
