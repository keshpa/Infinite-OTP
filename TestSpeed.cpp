...
static vector<uint16_t> substitutionTable;
static vector<uint16_t> reverseSubstitutionTable;
static vector<vector<uint16_t>> OTPs;
...
void testSpeed(vector<uint16_t>&input, vector<uint16_t>&userKey) {
	...
	{
		LOAD_PORTION(d, dataPtr, 0);
		Timer timer("Time taken to do 4 rounds of forward replacement and xor on 1024-bits: ", duration);
	...
	}	
	{
		...
		LOAD_PORTION(d, dataPtr, 0);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(0, 0, 0, 0);
		SET_PORTION(d, dataPtr, 0);
	}	
	{
		Timer timer("Time taken to load and alternate set plus do 4 rounds of forward replacement and xor on 1024-bits: ", duration);
		LOAD_PORTION(d, dataPtr, 0);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(0, 0, 0, 0);
		SET_PORTION_ALT(d, dataPtr, 0, 0);
	}	
	{
		Timer timer("Time taken to alternate load and alternate set plus do 4 rounds of forward replacement and xor on 1024-bits: ", duration);
		LOAD_PORTION_ALT(d, dataPtr, 0, 0);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(0, 0, 0, 0);
		SET_PORTION_ALT(d, dataPtr, 0, 0);
	}	
...

	{
		...
		LOAD_PORTION(d, dataPtr, 0);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(0, 0, 0, 0);
		LOAD_PORTION(d, dataPtr, 1);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(1, 0, 0, 2);
		LOAD_PORTION(d, dataPtr, 2);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(2, 0, 0, 4);
		LOAD_PORTION(d, dataPtr, 3);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(3, 0, 0, 6);
		LOAD_PORTION(d, dataPtr, 4);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(4, 0, 1, 0);
		LOAD_PORTION(d, dataPtr, 5);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(5, 0, 1, 2);
		LOAD_PORTION(d, dataPtr, 6);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(6, 0, 1, 4);
		LOAD_PORTION(d, dataPtr, 7);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(7, 0, 1, 6);
		LOAD_PORTION(d, dataPtr, 8);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(8, 0, 2, 0);
		LOAD_PORTION(d, dataPtr, 9);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(9, 0, 2, 2);
		LOAD_PORTION(d, dataPtr, 10);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(10, 0, 2, 4);
		LOAD_PORTION(d, dataPtr, 11);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(11, 0, 2, 6);
		LOAD_PORTION(d, dataPtr, 12);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(12, 0, 3, 0);
		LOAD_PORTION(d, dataPtr, 13);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(13, 0, 3, 2);
		LOAD_PORTION(d, dataPtr, 14);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(14, 0, 3, 4);
		LOAD_PORTION(d, dataPtr, 15);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(15, 0, 3, 6);
		LOAD_PORTION(d, dataPtr, 16);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(16, 0, 4, 0);
		LOAD_PORTION(d, dataPtr, 17);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(17, 0, 4, 2);
		LOAD_PORTION(d, dataPtr, 18);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(18, 0, 4, 4);
		LOAD_PORTION(d, dataPtr, 19);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(19, 0, 4, 6);
		LOAD_PORTION(d, dataPtr, 20);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(20, 0, 5, 0);
		LOAD_PORTION(d, dataPtr, 21);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(21, 0, 5, 2);
		LOAD_PORTION(d, dataPtr, 22);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(22, 0, 5, 4);
		LOAD_PORTION(d, dataPtr, 23);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(23, 0, 5, 6);
		LOAD_PORTION(d, dataPtr, 24);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(24, 0, 6, 0);
		LOAD_PORTION(d, dataPtr, 25);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(25, 0, 6, 2);
		LOAD_PORTION(d, dataPtr, 26);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(26, 0, 6, 4);
		LOAD_PORTION(d, dataPtr, 27);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(27, 0, 6, 6);
		LOAD_PORTION(d, dataPtr, 28);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(28, 0, 7, 0);
		LOAD_PORTION(d, dataPtr, 29);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(29, 0, 7, 2);
		LOAD_PORTION(d, dataPtr, 30);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(30, 0, 7, 4);
		LOAD_PORTION(d, dataPtr, 31);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(31, 0, 7, 6);
		SET_PORTION_ALL(d, dataPtr);
	}
	{
		Timer timer("Time taken to alternate load and do 4 rounds of forward replacement and xor on 4K. Followed by alternate set on all portions: ", duration);
		LOAD_PORTION_ALT(d, dataPtr, 0, 0);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(0, 0, 0, 0);
		LOAD_PORTION_ALT(d, dataPtr, 64, 1);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(1, 0, 0, 2);
		LOAD_PORTION_ALT(d, dataPtr, 128, 2);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(2, 0, 0, 4);
		LOAD_PORTION_ALT(d, dataPtr, 192, 3);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(3, 0, 0, 6);
		LOAD_PORTION_ALT(d, dataPtr, 256, 4);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(4, 0, 1, 0);
		LOAD_PORTION_ALT(d, dataPtr, 320, 5);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(5, 0, 1, 2);
		LOAD_PORTION_ALT(d, dataPtr, 384, 6);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(6, 0, 1, 4);
		LOAD_PORTION_ALT(d, dataPtr, 448, 7);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(7, 0, 1, 6);
		LOAD_PORTION_ALT(d, dataPtr, 512, 8);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(8, 0, 2, 0);
		LOAD_PORTION_ALT(d, dataPtr, 576, 9);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(9, 0, 2, 2);
		LOAD_PORTION_ALT(d, dataPtr, 640, 10);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(10, 0, 2, 4);
		LOAD_PORTION_ALT(d, dataPtr, 704, 11);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(11, 0, 2, 6);
		LOAD_PORTION_ALT(d, dataPtr, 768, 12);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(12, 0, 3, 0);
		LOAD_PORTION_ALT(d, dataPtr, 832, 13);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(13, 0, 3, 2);
		LOAD_PORTION_ALT(d, dataPtr, 896, 14);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(14, 0, 3, 4);
		LOAD_PORTION_ALT(d, dataPtr, 960, 15);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(15, 0, 3, 6);
		LOAD_PORTION_ALT(d, dataPtr, 1024, 16);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(16, 0, 4, 0);
		LOAD_PORTION_ALT(d, dataPtr, 1088, 17);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(17, 0, 4, 2);
		LOAD_PORTION_ALT(d, dataPtr, 1152, 18);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(18, 0, 4, 4);
		LOAD_PORTION_ALT(d, dataPtr, 1216, 19);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(19, 0, 4, 6);
		LOAD_PORTION_ALT(d, dataPtr, 1280, 20);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(20, 0, 5, 0);
		LOAD_PORTION_ALT(d, dataPtr, 1344, 21);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(21, 0, 5, 2);
		LOAD_PORTION_ALT(d, dataPtr, 1408, 22);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(22, 0, 5, 4);
		LOAD_PORTION_ALT(d, dataPtr, 1472, 23);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(23, 0, 5, 6);
		LOAD_PORTION_ALT(d, dataPtr, 1536, 24);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(24, 0, 6, 0);
		LOAD_PORTION_ALT(d, dataPtr, 1600, 25);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(25, 0, 6, 2);
		LOAD_PORTION_ALT(d, dataPtr, 1664, 26);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(26, 0, 6, 4);
		LOAD_PORTION_ALT(d, dataPtr, 1728, 27);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(27, 0, 6, 6);
		LOAD_PORTION_ALT(d, dataPtr, 1792, 28);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(28, 0, 7, 0);
		LOAD_PORTION_ALT(d, dataPtr, 1856, 29);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(29, 0, 7, 2);
		LOAD_PORTION_ALT(d, dataPtr, 1920, 30);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(30, 0, 7, 4);
		LOAD_PORTION_ALT(d, dataPtr, 1984, 31);
		FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(31, 0, 7, 6);
		SET_PORTION_ALL_ALT(d, dataPtr);
	}
	{
		Timer timer("Time taken to load, do 4 rounds of forward replacement and xor, and set on 4K (variables scoped): ", duration);
		{
			LOAD_PORTION(d, dataPtr, 0);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(0, 0, 0, 0);
			SET_PORTION(d, dataPtr, 0);
		}
		{
			LOAD_PORTION(d, dataPtr, 1);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(1, 0, 0, 2);
			SET_PORTION(d, dataPtr, 1);
		}
		{
			LOAD_PORTION(d, dataPtr, 2);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(2, 0, 0, 4);
			SET_PORTION(d, dataPtr, 2);
		}
		{
			LOAD_PORTION(d, dataPtr, 3);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(3, 0, 0, 6);
			SET_PORTION(d, dataPtr, 3);
		}
		{
			LOAD_PORTION(d, dataPtr, 4);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(4, 0, 1, 0);
			SET_PORTION(d, dataPtr, 4);
		}
		{
			LOAD_PORTION(d, dataPtr, 5);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(5, 0, 1, 2);
			SET_PORTION(d, dataPtr, 5);
		}
		{
			LOAD_PORTION(d, dataPtr, 6);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(6, 0, 1, 4);
			SET_PORTION(d, dataPtr, 6);
		}
		{
			LOAD_PORTION(d, dataPtr, 7);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(7, 0, 1, 6);
			SET_PORTION(d, dataPtr, 7);
		}
		{
			LOAD_PORTION(d, dataPtr, 8);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(8, 0, 2, 0);
			SET_PORTION(d, dataPtr, 8);
		}
		{
			LOAD_PORTION(d, dataPtr, 9);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(9, 0, 2, 2);
			SET_PORTION(d, dataPtr, 9);
		}
		{
			LOAD_PORTION(d, dataPtr, 10);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(10, 0, 2, 4);
			SET_PORTION(d, dataPtr, 10);
		}
		{
			LOAD_PORTION(d, dataPtr, 11);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(11, 0, 2, 6);
			SET_PORTION(d, dataPtr, 11);
		}
		{
			LOAD_PORTION(d, dataPtr, 12);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(12, 0, 3, 0);
			SET_PORTION(d, dataPtr, 12);
		}
		{
			LOAD_PORTION(d, dataPtr, 13);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(13, 0, 3, 2);
			SET_PORTION(d, dataPtr, 13);
		}
		{
			LOAD_PORTION(d, dataPtr, 14);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(14, 0, 3, 4);
			SET_PORTION(d, dataPtr, 14);
		}
		{
			LOAD_PORTION(d, dataPtr, 15);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(15, 0, 3, 6);
			SET_PORTION(d, dataPtr, 15);
		}
		{
			LOAD_PORTION(d, dataPtr, 16);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(16, 0, 4, 0);
			SET_PORTION(d, dataPtr, 16);
		}
		{
			LOAD_PORTION(d, dataPtr, 17);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(17, 0, 4, 2);
			SET_PORTION(d, dataPtr, 17);
		}
		{
			LOAD_PORTION(d, dataPtr, 18);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(18, 0, 4, 4);
			SET_PORTION(d, dataPtr, 18);
		}
		{
			LOAD_PORTION(d, dataPtr, 19);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(19, 0, 4, 6);
			SET_PORTION(d, dataPtr, 19);
		}
		{
			LOAD_PORTION(d, dataPtr, 20);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(20, 0, 5, 0);
			SET_PORTION(d, dataPtr, 20);
		}
		{
			LOAD_PORTION(d, dataPtr, 21);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(21, 0, 5, 2);
			SET_PORTION(d, dataPtr, 21);
		}
		{
			LOAD_PORTION(d, dataPtr, 22);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(22, 0, 5, 4);
			SET_PORTION(d, dataPtr, 22);
		}
		{
			LOAD_PORTION(d, dataPtr, 23);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(23, 0, 5, 6);
			SET_PORTION(d, dataPtr, 23);
		}
		{
			LOAD_PORTION(d, dataPtr, 24);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(24, 0, 6, 0);
			SET_PORTION(d, dataPtr, 24);
		}
		{
			LOAD_PORTION(d, dataPtr, 25);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(25, 0, 6, 2);
			SET_PORTION(d, dataPtr, 25);
		}
		{
			LOAD_PORTION(d, dataPtr, 26);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(26, 0, 6, 4);
			SET_PORTION(d, dataPtr, 26);
		}
		{
			LOAD_PORTION(d, dataPtr, 27);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(27, 0, 6, 6);
			SET_PORTION(d, dataPtr, 27);
		}
		{
			LOAD_PORTION(d, dataPtr, 28);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(28, 0, 7, 0);
			SET_PORTION(d, dataPtr, 28);
		}
		{
			LOAD_PORTION(d, dataPtr, 29);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(29, 0, 7, 2);
			SET_PORTION(d, dataPtr, 29);
		}
		{
			LOAD_PORTION(d, dataPtr, 30);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(30, 0, 7, 4);
			SET_PORTION(d, dataPtr, 30);
		}
		{
			LOAD_PORTION(d, dataPtr, 31);
			FORWARD_REPLACEMENT_AND_XOR_FOUR_ROUNDS(31, 0, 7, 6);
			SET_PORTION(d, dataPtr, 31);
		}
	}
}
